    ...
    def __init__(self, phy, dw,
        ...
        class TXDatapath(Module, AutoCSR):
            ...
            def add_crc(self):
                ...
                tx_crc = BufferizeEndpoints({"source": DIR_SOURCE}, pipe_ready=True)(BufferizeEndpoints({"sink": DIR_SINK}, pipe_ready=True)(tx_crc)) # FIXME: Still required?
        ...
        class RXDatapath(Module, AutoCSR):
            ...
            def add_crc(self):
                ...
                rx_crc = BufferizeEndpoints({"sink": DIR_SINK}, pipe_ready=True)(rx_crc) # FIXME: Still required?
