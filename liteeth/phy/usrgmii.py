...
class LiteEthPHYRGMIIRX(Module):
    def __init__(self, pads, rx_delay=2e-9):
        ...
        rx_ctl         = Signal()
        rx_ctl_CASC_a, rx_ctl_CASC_b, rx_ctl_CASC_c, rx_ctl_CASC_d = Signal(), Signal(), Signal(), Signal()
        rx_data_ibuf   = Signal(4)
        rx_data_idelay = Signal(4)
        rx_d_CASC_a, rx_d_CASC_b, rx_d_CASC_c, rx_d_CASC_d = Signal(4), Signal(4), Signal(4), Signal(4)
        rx_data        = Signal(8)
        ...
        self.specials += [
            ...
            Instance("IDELAYE3",
                ...
                p_CASCADE          = "MASTER",
                p_DELAY_TYPE       = "FIXED",
                p_DELAY_VALUE      = int(rx_delay/3*1e12),
                p_REFCLK_FREQUENCY = 300.0,
                p_DELAY_FORMAT     = "TIME",
                p_UPDATE_MODE      = "ASYNC",
                i_CASC_IN     = 0,
                i_CASC_RETURN = rx_ctl_CASC_d,
                i_CE          = 0,
                i_CLK         = 0,
                i_INC         = 0,
                i_LOAD        = 0,
            ...
            Instance("ODELAYE3",
                ...
                i_EN_VTC      = 1,
                i_ODATAIN     = 0,
                o_CASC_OUT    = rx_ctl_CASC_b,
                o_DATAOUT     = rx_ctl_CASC_d,
            ),
            Instance("IDELAYE3",
                p_CASCADE          = "SLAVE_END",
                p_DELAY_TYPE       = "FIXED",
        ...
        for i in range(4):
            self.specials += [
                ...
                Instance("ODELAYE3",
                    ...
                    i_EN_VTC      = 1,
                    i_ODATAIN     = 0,
                    o_CASC_OUT    = rx_d_CASC_b[i],
                    o_DATAOUT     = rx_d_CASC_d[i],
                ),
                Instance("IDELAYE3",
                    p_DELAY_SRC        = "IDATAIN",
                    p_CASCADE          = "SLAVE_END",
