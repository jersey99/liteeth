...
class LiteEthPHYRGMIIRX(Module):
    def __init__(self, pads, rx_delay=2e-9, usp=False, iodelay_clk_freq=300e6):
...
class LiteEthPHYRGMII(Module, AutoCSR):
    ...
    tx_clk_freq = 125e6
    rx_clk_freq = 125e6
    def __init__(self, clock_pads, pads, with_hw_init_reset=True, tx_delay=2e-9, rx_delay=2e-9, usp=False, iodelay_clk_freq=300e6):
        self.submodules.crg = LiteEthPHYRGMIICRG(clock_pads, pads, with_hw_init_reset, tx_delay)
        self.submodules.tx  = ClockDomainsRenamer("eth_tx")(LiteEthPHYRGMIITX(pads))
        self.submodules.rx  = ClockDomainsRenamer("eth_rx")(LiteEthPHYRGMIIRX(pads, rx_delay, usp, iodelay_clk_freq))
